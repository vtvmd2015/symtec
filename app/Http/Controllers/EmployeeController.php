...
class EmployeeController extends Controller {
	...
	public function __construct()
	{
		...
		$this->modelview = new  \App\Models\Employeedetails();
	...
	public function getIndex( Request $request )
	{
		...
		$sort = (!is_null($request->input('sort')) ? $request->input('sort') : 'employee_id'); 
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		if($row)
		{
			...
			$this->data['row'] = $this->model->getColumnTable('employee_t'); 
		}
	...
	public function postDelete( Request $request)
	{
		...
		if(count($request->input('ids')) >=1)
		{
			...
			\DB::table('employee_details_t')->where('employee_id',$request->input('id'))->delete();
