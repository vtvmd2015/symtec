  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('accountclass?return='.$return) }}">{{ $pageTitle }}</a></li>
...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'accountclass/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> ACCOUNT_CLASS</legend>
									
				  <div class="form-group hidethis " style="display:none;"> 
					<label for="Accountclass Id" class=" control-label col-md-4 text-left"> 
					{!! SiteHelpers::activeLang('Accountclass Id', (isset($fields['accountclass_id']['language'])? $fields['accountclass_id']['language'] : array())) !!}	
					</label>
					<div class="col-md-6">
					  {!! Form::text('accountclass_id', $row['accountclass_id'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
					 </div> 
					 <div class="col-md-2">
				  ...
				  <div class="form-group  " > 
					...
					{!! SiteHelpers::activeLang('Account Class', (isset($fields['accountclass_name']['language'])? $fields['accountclass_name']['language'] : array())) !!}	
					</label>
					<div class="col-md-6">
					  {!! Form::text('accountclass_name', $row['accountclass_name'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
					 </div> 
					 <div class="col-md-2">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('accountclass?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
