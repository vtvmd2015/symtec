									...
									<div class="row">
										<div class="col-md-6">
											<div class="input-group m-b">
											  {!! Form::text('start', $row['start'],array('class'=>'form-control date', 'placeholder'=>'', 'required'=>'true'   )) !!} 
											  <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											</div>
										 </div> 
										 <div class="col-md-6">
										 	<div class="input-group m-b">
										 		{!!  Form::text('end', $row['end'],array('class'=>'form-control date', 'placeholder'=>'', 'required'=>'true'   )) !!} 
												<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											</div>
										 </div>
									</div>	 
