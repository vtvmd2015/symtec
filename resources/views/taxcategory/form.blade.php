  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('taxcategory?return='.$return) }}">{{ $pageTitle }}</a></li>
...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'taxcategory/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> TAX_CATEGORY</legend>
				  ...
				  <div class="form-group hidethis " style="display:none;"> 
					...
					<div class="col-md-6">
					  {!! Form::text('taxcategory_id', $row['taxcategory_id'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
					 </div> 
					 <div class="col-md-2">
				  ...
				  <div class="form-group  " > 
					<label for="Taxcategory Name" class=" control-label col-md-4 text-left"> 
					{!! SiteHelpers::activeLang('Taxcategory Name', (isset($fields['taxcategory_name']['language'])? $fields['taxcategory_name']['language'] : array())) !!}	
					</label>
					<div class="col-md-6">
					  {!! Form::text('taxcategory_name', $row['taxcategory_name'],array('class'=>'form-control', 'placeholder'=>'', 'required'=>'true'  )) !!} 
					 </div> 
					 <div class="col-md-2">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('taxcategory?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
