...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'holidays/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> HOLIDAYS</legend>
									
				  <div class="form-group hidethis " style="display:none;"> 
					<label for="Holiday Id" class=" control-label col-md-4 text-left"> 
					{!! SiteHelpers::activeLang('Holiday Id', (isset($fields['holiday_id']['language'])? $fields['holiday_id']['language'] : array())) !!}	
					</label>
					<div class="col-md-6">
					  {!! Form::text('holiday_id', $row['holiday_id'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
					 </div> 
					 <div class="col-md-2">
				  ...
				  <div class="form-group  " > 
					<label for="Holiday Date" class=" control-label col-md-4 text-left"> 
					{!! SiteHelpers::activeLang('Holiday Date', (isset($fields['holiday_date']['language'])? $fields['holiday_date']['language'] : array())) !!}	
					</label>
					<div class="col-md-6">
					  
				<div class="input-group m-b" style="width:150px !important;">
					{!! Form::text('holiday_date', $row['holiday_date'],array('class'=>'form-control date')) !!}
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('holidays?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
