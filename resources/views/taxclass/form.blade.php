  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('taxclass?return='.$return) }}">{{ $pageTitle }}</a></li>
...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'taxclass/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> TAX_CLASS</legend>
									
				  <div class="form-group hidethis " style="display:none;"> 
					<label for="Taxclass Id" class=" control-label col-md-4 text-left"> 
					{!! SiteHelpers::activeLang('Taxclass Id', (isset($fields['taxclass_id']['language'])? $fields['taxclass_id']['language'] : array())) !!}	
					</label>
					<div class="col-md-6">
					  {!! Form::text('taxclass_id', $row['taxclass_id'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
					 </div> 
					 <div class="col-md-2">
				  ...
				  <div class="form-group  " > 
					<label for="Taxclass Name" class=" control-label col-md-4 text-left"> 
					{!! SiteHelpers::activeLang('Taxclass Name', (isset($fields['taxclass_name']['language'])? $fields['taxclass_name']['language'] : array())) !!}	
					</label>
					<div class="col-md-6">
					  {!! Form::text('taxclass_name', $row['taxclass_name'],array('class'=>'form-control', 'placeholder'=>'', 'required'=>'true'  )) !!} 
					 </div> 
					 <div class="col-md-2">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('taxclass?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
