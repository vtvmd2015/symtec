    ...
    <div class="page-header">
 	...
 	<div class="page-content-wrapper">   
	   <div class="toolbar-line">
	   		<a href="{{ URL::to('accountcategory?return='.$return) }}" class="tips btn btn-xs btn-default" title="{{ Lang::get('core.btn_back') }}"><i class="fa fa-arrow-circle-left"></i>&nbsp;{{ Lang::get('core.btn_back') }}</a>
			@if($access['is_add'] ==1)
	   		<a href="{{ URL::to('accountcategory/update/'.$id.'?return='.$return) }}" class="tips btn btn-xs btn-primary" title="{{ Lang::get('core.btn_edit') }}"><i class="fa fa-edit"></i>&nbsp;{{ Lang::get('core.btn_edit') }}</a>
			@endif  		   	  
		</div>
	...
	<table class="table table-striped table-bordered" >
		<tbody>	
					...
					<tr>
						...
						<td>{!! SiteHelpers::gridDisplayView($row->accountclass_id,'accountclass_id','1:account_class_t:accountclass_id:accountclass_name') !!} </td>
					...
					<tr>
						...
						<td>{{ $row->accountcategory_name }} </td>
