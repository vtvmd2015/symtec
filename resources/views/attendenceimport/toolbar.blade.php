<div class="row m-b">
	<div class="col-md-6">
			...
			{!! AjaxHelpers::buttonActionCustom('uploadattendance',$setting, 'Upload Attendance','upload') !!}
                        
                        <a href="javascript://ajax" class="btn btn-sm btn-success" onclick="ajaxUpdatestatus('#{{ $pageModule }}','{{ $pageUrl }}')"><i class="fa fa-thumbs-up"></i> Approve </a>
