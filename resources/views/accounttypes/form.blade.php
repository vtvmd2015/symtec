  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('accounttypes?return='.$return) }}">{{ $pageTitle }}</a></li>
...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'accounttypes/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> ACCOUNT_TYPES</legend>
									
				  <div class="form-group hidethis " style="display:none;"> 
					<label for="Accounttype Id" class=" control-label col-md-4 text-left"> 
					{!! SiteHelpers::activeLang('Accounttype Id', (isset($fields['accounttype_id']['language'])? $fields['accounttype_id']['language'] : array())) !!}	
					</label>
					<div class="col-md-6">
					  {!! Form::text('accounttype_id', $row['accounttype_id'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
					 </div> 
					 <div class="col-md-2">
				  ...
				  <div class="form-group  " > 
					<label for="Accounttype Name" class=" control-label col-md-4 text-left"> 
					{!! SiteHelpers::activeLang('Accounttype Name', (isset($fields['accounttype_name']['language'])? $fields['accounttype_name']['language'] : array())) !!}	
					</label>
					<div class="col-md-6">
					  {!! Form::text('accounttype_name', $row['accounttype_name'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
					 </div> 
					 <div class="col-md-2">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('accounttypes?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
